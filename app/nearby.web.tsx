...
// Use platform-specific MapView for web
...
export default function NearbyScreen() {
  ...
  const loadServices = async () => {
    try {
      ...
      const validServices = fetchedServices
        .filter(service => service.id && service.latitude && service.longitude)
        .map(service => service as Service);
      
      console.log('🔧 ServiceService returned:', validServices);
      console.log('🔧 validServices length:', validServices?.length || 0);
