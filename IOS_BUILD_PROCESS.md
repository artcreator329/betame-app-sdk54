...
### Local Production Build (App Store) - Version 1.0.0 (14)
- **Build Method**: Local Xcode build (no EAS)
- **Status**: ✅ Completed
- **Distribution**: App Store Connect
- **Artifact**: `ios/build/ipa/BetaMe.ipa` (70.7 MB)
...
- **Team**: T72JDH8ZL6 (BETAME SDN. BHD.)
- **Provisioning Profile**: iOS Team Store Provisioning Profile
- **Created**: August 31, 2025 (09:06)

### Local Production Build (App Store) - Version 1.0.1 (1)
- **Build Method**: Local Xcode build (no EAS)
- **Status**: ✅ Completed
- **Distribution**: App Store Connect
- **Artifact**: `ios/build/ipa/BetaMe.ipa` (70.7 MB)
...
- **Team**: T72JDH8ZL6 (BETAME SDN. BHD.)
- **Provisioning Profile**: iOS Team Store Provisioning Profile
- **Created**: August 31, 2025 (11:19)

### Local Production Build (App Store) - Version 1.0.0 (15)
- **Build Method**: Local Xcode build (no EAS)
- **Status**: ✅ Completed
- **Distribution**: App Store Connect
- **Artifact**: `ios/build/ipa/BetaMe.ipa` (70.7 MB)
...
### Local Production Build (App Store) - Version 1.0.0 (28)
- **Build Method**: Local Xcode build (no EAS)
- **Status**: ✅ Completed
- **Distribution**: App Store Connect
- **Artifact**: `ios/build/ipa/BetaMe.ipa` (77.5 MB)
...
- **Team**: T72JDH8ZL6 (BETAME SDN. BHD.)
- **Provisioning Profile**: iOS Team Store Provisioning Profile
- **Created**: September 7, 2025 (09:19)
- **Icon Fix**: ✅ **CONFIRMED WORKING** - Build 28 continues to use the correct `icon.png` icon
- **Changes**: Standard build number increment, all dependencies and configurations maintained

### Local Production Build (App Store) - Version 1.0.1 (9)
- **Build Method**: Local Xcode build (no EAS)
- **Status**: ✅ Completed
- **Distribution**: App Store Connect
...
- **Team**: T72JDH8ZL6 (BETAME SDN. BHD.)
- **Provisioning Profile**: iOS Team Store Provisioning Profile
- **Created**: September 8, 2025 (21:20)
- **Icon Fix**: ✅ **CONFIRMED WORKING** - Build 9 continues to use the correct `icon.png` icon
- **Changes**: Updated to version 1.0.1 with build number 9, all dependencies and configurations maintained

### Local Production Build (App Store) - Version 1.0.1 (10)
- **Build Method**: Local Xcode build (no EAS)
- **Status**: ✅ Completed
- **Distribution**: App Store Connect
- **Artifact**: `ios/build/ipa/BetaMe.ipa` (77.8 MB)
...
- **Team**: T72JDH8ZL6 (BETAME SDN. BHD.)
- **Provisioning Profile**: iOS Team Store Provisioning Profile
- **Created**: September 8, 2025 (23:36)
- **Icon Fix**: ✅ **CONFIRMED WORKING** - Build 10 continues to use the correct `icon.png` icon
- **Changes**: Updated to version 1.0.1 with build number 10, added https://betame.com.my to linking prefixes, all dependencies and configurations maintained

### Local Production Build (App Store) - Version 1.0.1 (11)
- **Build Method**: Local Xcode build (no EAS)
- **Status**: ✅ Completed
- **Distribution**: App Store Connect
- **Artifact**: `ios/build/ipa/BetaMe.ipa` (77.8 MB)
...
- **Team**: T72JDH8ZL6 (BETAME SDN. BHD.)
- **Provisioning Profile**: iOS Team Store Provisioning Profile
- **Created**: September 9, 2025 (00:32)
...
### Local Production Build (App Store) - Version 1.0.2 (20)
- **Build Method**: Local Xcode build (no EAS)
- **Status**: ✅ Completed
- **Distribution**: App Store Connect
- **Artifact**: `ios/build/ipa/BetaMe.ipa` (77.8 MB)
...
- **Team**: T72JDH8ZL6 (BETAME SDN. BHD.)
- **Provisioning Profile**: iOS Team Store Provisioning Profile
- **Created**: September 12, 2025 (10:28)
- **Icon Fix**: ✅ **CONFIRMED WORKING** - Build 20 continues to use the correct `icon.png` icon
- **Changes**: Updated to version 1.0.2 with build number 20, added service/[id] deep link route, all dependencies and configurations maintained
